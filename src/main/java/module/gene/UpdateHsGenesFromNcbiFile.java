...
public class UpdateHsGenesFromNcbiFile extends DatabaseTemplate {
	...
	public UpdateHsGenesFromNcbiFile() {
	...
	public void process()  {
		...
		String inputfile = "Homo_sapiens.gene_info";
